...
import com.example.springawssqsexample.dynamodb.UserExchangeRecordDao;
...
public class SpringAwsSqsExampleApplication implements CommandLineRunner {
  ...
  @Autowired
  private UserExchangeRecordDao userExchangeRecordDao;
  ...
  public void run(String... args) throws Exception {
    ...
    userExchangeRecordDao.createUserExchangeRecord();
  }
}
